  ...
  return (
    <div className="relative">
      ...
      <TextCard className="space-y-4">
        ...
        <RichHtml className="font-worksans text-black text-sm leading-[22px] tracking-[0.14px] [&_p]:m-0" html={fields.cinco_grupos_intro} />
        <RichHtml html={fields.cinco_grupos_lista} />
        <div className="pt-2">
