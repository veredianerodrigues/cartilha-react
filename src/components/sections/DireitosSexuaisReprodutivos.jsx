  ...
  return (
    <div className="relative">
      ...
      <HighlightCard variant="blue" className="space-y-4">
        ...
        <Paragraph>
          Como resultado de reivindicações coletivas, emergiu a noção de direitos à saúde sexual e
          ...
          prevenção da gravidez e de doenças sexualmente transmissíveis (DST) e Aids".<Cite n={3} /> (p. 16)
        </Paragraph>
        <Paragraph>
          Os direitos reprodutivos referem-se à possibilidade "[...] de acesso a informações, meios, métodos e
          técnicas para ter ou não filhos".<Cite n={3} /> (p. 15)
        </Paragraph>
        <Paragraph>
